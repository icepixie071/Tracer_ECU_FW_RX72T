...
void R_Config_MTU6_MTU7_Create(void)
{
    ...
    MTU.TDDRB = _07D0_TDDRB_VALUE;
    MTU.TCDRB = _2710_TCDRB_VALUE;
    MTU.TCBRB = _2710_TCDRB_VALUE;
    MTU6.TGRA = _2EE0_SUM_VALUE;
    MTU6.TGRC = _2EE0_SUM_VALUE;
    MTU.TOCR1B.BYTE = _00_MTU_PSYE_DISABLE | _08_MTU_TOCL_DISABLE | _04_MTU_TOCS_TOCR2;
    MTU.TOCR2B.BYTE = _00_MTU_TOLBR_DIS | _00_MTU_OLS3N_HL | _00_MTU_OLS3P_HL | _00_MTU_OLS2N_HL | _00_MTU_OLS2P_HL | 
