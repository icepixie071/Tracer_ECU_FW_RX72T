...
void R_Config_S12AD0_Create(void)
{
    ...
    S12AD.ADSHCR.WORD = _0100_AD_DSH_ANx00_SELECT | _0200_AD_DSH_ANx01_SELECT | _0400_AD_DSH_ANx02_SELECT | 
                        _001B_AD0_DSH_SAMPLING_STATE;

    /* Set AN000 amplifier */
    S12AD.ADPGADCR0.BIT.P000DEN = 1U;
    S12AD.ADPGADCR0.BIT.P000DG = _0001_AD_GAIN_PSEUDO_DIFF_4_000;
    S12AD.ADPGAGS0.BIT.P000GAIN = _0008_AD_GAIN_PSEUDO_DIFF_4_000;
    S12AD.ADPGACR.BIT.P000CR = _000E_AD_PATH_Px_NONE_Px;

    /* Set AN001 amplifier */
    S12AD.ADPGADCR0.BIT.P001DEN = 1U;
    S12AD.ADPGADCR0.BIT.P001DG = _0001_AD_GAIN_PSEUDO_DIFF_4_000;
    S12AD.ADPGAGS0.BIT.P001GAIN = _0008_AD_GAIN_PSEUDO_DIFF_4_000;
    S12AD.ADPGACR.BIT.P001CR = _000E_AD_PATH_Px_NONE_Px;

    /* Set AN002 amplifier */
    S12AD.ADPGADCR0.BIT.P002DEN = 1U;
    S12AD.ADPGADCR0.BIT.P002DG = _0001_AD_GAIN_PSEUDO_DIFF_4_000;
    S12AD.ADPGAGS0.BIT.P002GAIN = _0008_AD_GAIN_PSEUDO_DIFF_4_000;
    S12AD.ADPGACR.BIT.P002CR = _000C_AD_PATH_NONE_NONE_Px;
